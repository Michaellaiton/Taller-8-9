...
import co.edu.sena.taller2michaellaiton.model.Category;
import co.edu.sena.taller2michaellaiton.model.repository.CategoryRepositoryImpl;
...
public class CategoryRegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        co.edu.sena.taller2michaellaiton.model.repository.Repository<Category> repository = new CategoryRepositoryImpl();
        int rows = 0;
        try {
