...
import co.edu.sena.taller2michaellaiton.servlet.UserRepositoryImpl;
...
public class UserRegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        co.edu.sena.taller2michaellaiton.model.repository.Repository<User> repository = new UserRepositoryImpl();
        int rows = 0;
        try {
